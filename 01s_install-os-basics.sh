...
echo "wget https://raw.githubusercontent.com/frennkie/kiosk-pi/master/03_add-user.sh"
echo "wget https://raw.githubusercontent.com/frennkie/kiosk-pi/master/04_setup-x11.sh"
